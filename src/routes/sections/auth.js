...
const JwtRegisterAlumnoPage = lazy(() => import('src/pages/auth/jwt/registerAlumno'));
...
const authJwt = {
  ...
  children: [
    ...
    },
    {
      ...
      element: (
        <AuthClassicLayout title="La mejor plataforma de gestión de proyectos">
          <JwtRegisterAlumnoPage />
        </AuthClassicLayout>
      ),
    },
  ],
