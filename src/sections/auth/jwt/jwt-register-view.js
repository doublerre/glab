...
export default function JwtRegisterView() {
	...
	const onSubmit = handleSubmit(async (data) => {
		try {
			await register?.(data.email, data.password, data.passwordConfirm, data.name, data.username, "Solicitante", true);
	...
	const renderHead = (
		<Stack spacing={2} sx={{ mb: 5, position: 'relative' }}>
			<Typography variant="h4">Registro de Solicitantes</Typography>
